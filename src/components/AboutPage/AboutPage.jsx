...
function AboutPage() {
  ...
  return (
    <>
      <Container>
        <Card style={{ backgroundImage: "linear-gradient(to top, #d5d4d0 0%, #d5d4d0 1%, #eeeeec 31%, #efeeec 75%, #e9e9e7 100%)" }}>
          <CardContent>
        ...
        <Card style={{ backgroundImage: "linear-gradient(to top, #d5d4d0 0%, #d5d4d0 1%, #eeeeec 31%, #efeeec 75%, #e9e9e7 100%)" }}>
          ...
          <CardActions disableSpacing>
            ...
            {/* <Link size="small" color="secondary" to="https://www.aa.org/find-aa/north-america">
            Contact
          </Link> */}
